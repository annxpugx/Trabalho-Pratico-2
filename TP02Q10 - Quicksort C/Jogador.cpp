...
void quicksortRec(Jogador *array, int esq, int dir, int *comp, int *mov) {
    int i = esq, j = dir;
    ...
    if (esq < j)  quicksortRec(array, esq, j, comp, mov);
    if (i < dir)  quicksortRec(array, i, dir, comp, mov);
}
//=============================================================================
void quicksort(Jogador *array, int n, int *comp, int *mov) {
